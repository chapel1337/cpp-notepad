...
void textViewer()
{
    ...
    if (textViewerResponse == "exit" || textViewerResponse == "back")
    {
        file = "";
        fileDirectory = "";
        fileName = "";
    ...
    else if (textViewerResponse == "corrections" || textViewerResponse == "correct")
    {
...
void openTextHandler()
{
    ...
    else
    {
        ...
        cout << "input exit to go back\n";
        cout << "input corrections to toggle corrections\n";
